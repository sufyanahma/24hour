...
\033[1;96m               | |                      
\033[1;96m               |_|   Sufyan Updated 0.3                   
\033[1;91m       ♦♦♦———————————————————————————————♦♦♦
"""
def tik():
	titik = ['.   ','..  ','... ']
...
jalan("   \033[1;93m Welcome to Sufyan Creations ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mSufyantiger\033[1;96m•◈•──────────•◈•")
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.Youtube.com/https://www.youtube.com/channel/UCKoxMkvX0kdfztguDxxe09w')
    else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/https://www.youtube.com/channel/UCKoxMkvX0kdfztguDxxe09w')
...
def pilih_super():
	...
	jalan('                    \033[1;97mSufyan start cloning Wait...')
	print  "  \033[1;36;48m ●💋══════════════════◄►══════════════════💋●" 
